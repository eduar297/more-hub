...
export const settingStyles = StyleSheet.create({
  ...
  listContent: { padding: 16, flexGrow: 1, paddingBottom: 100 },
  centerBox: {
    flex: 1,
    alignItems: "center",
  ...
  workerInfo: { flex: 1, gap: 2, minWidth: 0 },
  workerName: { fontSize: 14, fontWeight: "600" },
  workerMeta: { fontSize: 11 },
  ...
  // Profile
  profileContent: { paddingHorizontal: 16, gap: 14, paddingBottom: 100 },
